...
mkdir "$stage/$name"
for path in Cargo.toml Cargo.lock rust-toolchain.toml CMakeLists.txt LICENSE README.md FEATURES.md SCOPE.md ARCHITECTURE.md CREDITS.md VERIFICATION.md .github src ui packaging tests scripts; do
