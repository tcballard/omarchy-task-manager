...
mkdir "$stage/$name"
for path in Cargo.toml Cargo.lock rust-toolchain.toml CMakeLists.txt LICENSE RELEASE_NOTES.md README.md FEATURES.md SCOPE.md ARCHITECTURE.md CREDITS.md VERIFICATION.md HARDENING.md HARDENING.sha256 .github src ui packaging tests scripts; do
